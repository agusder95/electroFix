...
<div class="card-wrapper">
      ...
      <div class="card">
        ...
        <p>
          ...
          comprometida con la calidad y excelencia <br /> Nuestra vocación es servir al
          primer contacto
        </p>
      </div>
     ...
     <li><img className="FooterIcon" src={faceIcon} alt="faceIcon" />   </li>
     <li>  <img className="FooterIcon" src={instaIcon} alt="instaIcon" />  </li>
        </ul>
      </div>
      </div >
